...
rem schtasks /change /TN "\Microsoft\Windows\SettingSync\BackgroundUploadTask" /Disable | Out-Null
...
rem schtasks /change /TN "\Microsoft\Windows\SkyDrive\Idle Sync Maintenance Task" /Disable | Out-Null
